...
class Tri(Shape):
    ...
    def area(self):
        return ((self.point1.distance(self.point2) + self.point2.distance(self.point3)) / 4) * self.point3.distance(self.point1)
    def perimeter(self):
        return (self.point1.distance(self.point2) + self.point2.distance(self.point3) + self.point3.distance(self.point1))
cheese = Tri(Point(0,0,0), Point(1,1,0), Point(1,0,0))
print(cheese.area())
